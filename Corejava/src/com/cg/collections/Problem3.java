...
class Problem3 {
	...
	public static void main(String[] args) {
		...
		Details2.add(new Employee(1, "deep", "RM", 22000));
		Details2.add(new Employee(2, "savu", "BU", 24000));
		Details2.add(new Employee(3, "nandu", "LM", 26000));
		Details2.add(new Employee(4, "vijju", "AM", 28000));
